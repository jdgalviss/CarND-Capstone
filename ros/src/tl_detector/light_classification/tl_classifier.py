...
class TLClassifier(object):
    def __init__(self):
        self.model = ObjectDetector("/capstone/models/obj.pb")

        self.traffic_lights_model = ti.estimator.SavedModelPredictor('/capstone/models/traffic-light')
...
class TrafficLightsUtils(object):
    TRAFFIC_CATEGORIES = ['Walk-off', 'Yellow', 'Walk-precaution', 'Green', 'Walk-allow', 'Red', 'Walk-stop', 'Off']
    OFFSET = 2
